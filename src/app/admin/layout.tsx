...
export default function AdminLayout({
  ...
  return (
    <div className="flex-1 flex">
      <aside className="hidden w-60 shrink-0 flex-col border-r border-line bg-[#0d0d0d] sm:flex">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex items-center justify-between border-b border-line bg-[#0d0d0d] px-4 py-3 sm:hidden">
